          ...
          <div className="App">
            ...
            <Grid>
              <Switch>
                ...
                <Authenticated exact path="/documents" component={DocumentsList} setAfterLoginPath={setAfterLoginPath} {...props} {...state} />
                <Authenticated exact path="/documents/:_id" component={DocumentRoute} docComponent={ViewDocument} collection={DocumentsCollection} goToOnRemove={'/documents'} setAfterLoginPath={setAfterLoginPath} {...props} {...state} />
